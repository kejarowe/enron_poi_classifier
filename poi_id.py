...
#features_list =['poi','shared_receipt_with_poi', 'from_poi_to_this_person', 'loan_advances', 'from_this_person_to_poi', 'to_messages', 'director_fees', 'total_payments', 'deferral_payments', 'exercised_stock_options', 'deferred_income', 'total_stock_value', 'from_messages', 'bonus', 'other', 'restricted_stock', 'long_term_incentive', 'expenses', 'restricted_stock_deferred', 'salary'] #All features  
features_list = ['poi', 'shared_receipt_with_poi', 'from_poi_to_this_person', 'loan_advances', 'from_this_person_to_poi', 'to_messages', 'director_fees', 'total_payments', 'exercised_stock_options', 'deferred_income', 'total_stock_value', 'bonus', 'other', 'restricted_stock', 'long_term_incentive', 'expenses', 'restricted_stock_deferred', 'salary'] #Best features to use as determined by GridSearchCV and SelectKBest
